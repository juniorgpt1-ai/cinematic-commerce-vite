...
const heroPerfume = "/hero-perfume.jpg";
...
function FloatingBadge({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <motion.span
      ...
      className={`inline-flex items-center gap-2 border border-luxe-gold/60 bg-luxe-bg/90 backdrop-blur-xs px-3.5 py-1.5 shadow-md ${className}`}
    >
      {children}
    </motion.span>
  );
...
function Nav() {
  return (
    <header className="absolute top-0 inset-x-0 z-30">
      <div className="mx-auto max-w-7xl px-6 py-6 flex items-center justify-between text-white">
        <div className="leading-tight">
          <div className="font-display text-xl font-semibold tracking-[0.18em] uppercase">
            Maison<span className="text-luxe-gold-soft"> · </span>Fragrance
          </div>
          <div className="mt-1 text-[9px] tracking-[0.24em] uppercase text-white/60 font-sans">
...
function Hero() {
  ...
  return (
    <section className="relative min-h-screen w-full bg-[#070707] text-white overflow-hidden flex flex-col justify-end">
      ...
      <div className="relative z-10 mx-auto max-w-7xl w-full px-6 pt-40 pb-24 md:pt-48 md:pb-32 flex flex-col justify-end">
        <motion.div {...fade} className="max-w-3xl">
          <div className="mb-8">
            <FloatingBadge className="border-luxe-gold-soft/40 bg-black/85">
          ...
          <h1 className="font-display text-[11vw] md:text-[5.5rem] leading-[1.05] tracking-tight font-bold">
            Indulgência Inteligente:
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-luxe-gold-soft via-white to-luxe-gold font-light italic">
              Luxo Acessível
            </span>
            <br />
            Para Todos.
          ...
          <p className="mt-8 max-w-xl text-base md:text-lg text-white/70 font-sans font-light leading-relaxed">
            Descubra uma seleção curada de alta performance e custo-benefício refinado.
            O ritual de luxo que cabe no seu dia a dia, com entrega expressa em até 60 minutos via Uber Flash.
          </p>

          <div className="mt-12 flex flex-wrap items-center gap-5">
            <a
              href={waLink(
                "Olá! Vim pela página e quero conhecer a perfumaria e hair care de luxo inteligente com entrega em 1h.",
              )}
              target="_blank"
              rel="noreferrer"
              className="group inline-flex items-center gap-3 bg-whatsapp hover:bg-whatsapp-hover text-black font-bold px-8 py-4 text-base tracking-wide transition-all shadow-[0_0_20px_rgba(37,211,102,0.2)] hover:shadow-[0_0_25px_rgba(37,211,102,0.4)]"
            >
              <MessageCircle className="size-5" />
              Quero Luxo Inteligente
          ...
          <div className="mt-16 flex items-center gap-6 text-[10px] tracking-[0.32em] uppercase text-white/50 font-semibold">
...
function TrustBar() {
  const items = [
    ...
    {
      icon: Gift,
      title: "Indulgência Inclusa",
      desc: "Embalagem sofisticada premium inclusa gratuitamente em todos os seus pedidos.",
    },
  ];
  const fade = useFadeUp();
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
          {items.map((it, i) => (
            ...
            >
              ...
              <h3 className="font-display text-xl leading-tight font-bold">{it.title}</h3>
      ...
      <div className="mx-auto max-w-7xl px-6 py-24 md:py-36 relative z-10">
        <motion.div {...fade} className="max-w-3xl mb-20 text-center mx-auto">
          ...
          <h2 className="mt-4 font-display text-4xl md:text-6xl font-bold leading-tight">
            A Inteligência do Cuidado Absoluto
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center mb-24 md:mb-32">
          <motion.div {...fade} className="lg:col-span-6 relative">
            <div className="relative aspect-[4/5] overflow-hidden bg-[#121212] shadow-2xl border border-luxe-line/30 group">
              <img
                ...
                alt="Modelo lavando cabelos volumosos com espuma luxuosa no chuveiro"
                loading="lazy"
                className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-black/20" />
              <div className="absolute top-6 left-6 right-6 flex items-center justify-between text-white/80 text-[10px] tracking-[0.32em] uppercase font-semibold">
                <span>RITUAL DE VOLUME</span>
                <span>Nº 01</span>
              </div>
            </div>
          ...
          >
            ...
            <h3 className="mt-4 font-display text-3xl md:text-5xl font-bold leading-tight">
              Descubra a inteligência do encorpamento.
            </h3>
            <span className="gold-rule mt-6" />
            
            <p className="mt-6 text-lg text-luxe-ink-soft font-sans font-light leading-relaxed">
              Inteligência Artificial preenche sua fibra. Volumiza, hidrata e elimina a porosidade. Abrace o luxo inteligente de fios encorpados, com brilho tridimensional e balanço natural.
            </p>
            ...
            <div className="mt-10 flex items-center justify-between gap-6 flex-wrap border-t border-luxe-line/30 pt-8">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex items-center gap-3 bg-luxe-ink hover:bg-whatsapp text-white hover:text-black transition-all px-7 py-4 text-sm font-semibold tracking-wide shadow-md"
              >
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 md:py-28 relative z-10">
        ...
        >
          <motion.div {...fade} className={reverse ? "lg:col-span-5 relative" : "lg:col-span-7 relative"}>
            ...
            <div className={`absolute -bottom-5 ${reverse ? "-left-4" : "-right-4"} z-20`}>
          ...
          >
            ...
            <h2 className="mt-6 font-display text-4xl md:text-5xl font-bold leading-[1.08] tracking-tight">
              {title}
            </h2>
            ...
            <dl className="mt-10 grid grid-cols-3 gap-6 border-t border-luxe-line/30 pt-8 font-sans">
              {notes.map((n, i) => (
                <div key={n}>
            ...
            <div className="mt-8 inline-flex items-center gap-2 border border-luxe-gold/40 bg-luxe-gold/5 px-3 py-1.5 rounded-xs">
            ...
            <div className="mt-10 flex items-end justify-between gap-6 flex-wrap">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex items-center gap-3 bg-luxe-ink hover:bg-whatsapp text-white hover:text-black transition-colors px-8 py-4 text-base md:text-sm font-semibold tracking-wide shadow-md"
              >
                <MessageCircle className="size-4" />
                {cta}
                <ArrowRight className="size-4 group-hover:translate-x-1 transition-transform" />
      ...
      <div className="mx-auto max-w-7xl px-6 py-20 md:py-28 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <motion.div {...fade} className="lg:col-span-7 relative">
            ...
            <div className="absolute -bottom-4 -right-4 z-20 w-28 md:w-36 shadow-2xl border-2 border-luxe-line/30">
              <img
                src={malbecBottleImg}
                alt="Frasco Malbec O Boticário"
          ...
          >
            ...
            <div className="mt-10 flex items-end justify-between gap-6 flex-wrap">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group inline-flex items-center gap-3 bg-luxe-ink hover:bg-whatsapp text-white hover:text-black transition-colors px-8 py-4 text-sm font-semibold tracking-wide shadow-md"
              >
                <MessageCircle className="size-4" />
                Garantir meu Malbec
                <ArrowRight className="size-4 group-hover:translate-x-1 transition-transform" />
  ...
  const products: CarouselProduct[] = [
    {
      ...
      brand: "O Boticário",
      tag: "Best Seller",
      desc: "Floral opulento extraído através do método artesanal de enfleurage. Elegância pura.",
      price: "R$ 349,90",
      ctaText: "Garantir Lily",
      waMsg: "Olá! Quero garantir o Lily Eau de Parfum da seleção dos mais amados com entrega em 1h.",
    },
    {
        ...
        >
          {products.map((prod, idx) => (
            <motion.div
              ...
              className="min-w-[290px] md:min-w-[340px] max-w-[340px] bg-black/35 backdrop-blur-xs border border-white/10 p-8 rounded-xs snap-start flex flex-col justify-between group hover:border-luxe-gold/50 transition-all duration-300 hover:translate-y-[-4px]"
            >
              <div>
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-between">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 text-xs font-semibold tracking-wider uppercase text-luxe-gold-soft hover:text-white border-b border-luxe-gold-soft/50 hover:border-white pb-1 transition-all"
                >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-luxe-gold/20">
          {kits.map((k, i) => (
            ...
            >
              ...
              <div>
                <div className="mt-8 inline-flex items-center gap-2 border border-luxe-gold-soft/40 bg-luxe-gold/5 px-3 py-1.5 self-start rounded-xs">
                  <Timer className="size-3.5 text-luxe-gold-soft" />
                ...
                <div className="mt-10 pt-6 border-t border-white/10 flex items-end justify-between gap-4">
                  <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 text-xs font-semibold tracking-wider uppercase text-luxe-gold-soft border-b border-luxe-gold-soft/60 pb-1 group-hover:text-white group-hover:border-white transition-colors"
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-20 items-center">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-10 inline-flex items-center gap-3 bg-luxe-ink hover:bg-whatsapp hover:text-black text-white transition-colors px-8 py-4 text-sm font-semibold tracking-wide shadow-md"
            >
              <MessageCircle className="size-4" />
          ...
          {items.map((t, i) => (
            ...
            >
              <div>
                ...
                <blockquote className="mt-6 font-display text-xl leading-relaxed text-luxe-ink">
                  &ldquo;{t.quote}&rdquo;
                </blockquote>
              </div>
          ...
          {items.map((it, i) => {
            ...
            return (
              <div key={it.q}>
                ...
                >
                  <span className="font-display text-xl md:text-2xl text-luxe-ink group-hover:text-luxe-gold transition-colors font-bold">
                    {it.q}
                  </span>
                  <ChevronDown
    ...
    <section className="relative bg-luxe-ink text-white overflow-hidden py-32 md:py-40">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center z-10">
        <motion.div {...fade}>
          ...
          <h2 className="mt-8 font-display text-4xl md:text-7xl font-bold leading-[1.05]">
          ...
          <div className="mt-12">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="wa-pulse-strong inline-flex items-center gap-3 bg-whatsapp hover:bg-whatsapp-hover text-black font-bold px-12 py-6 text-lg md:text-xl tracking-wider uppercase rounded-sm transition-all"
            >
